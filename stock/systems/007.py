...
for _, symbol_row in df_symbols.iterrows():
    ...
    for _, row in df_data.iterrows():
        ...
        # NOWE: Small buy - jeśli pozycja otwarta i NIE ma głównego triggera
        if position_open and not main_buy_trigger:
            amount = 4.0
            buy_type = 'small'
            buy_price = current_price
            shares_bought = amount / buy_price
